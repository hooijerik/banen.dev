...
eq("SalesOps", detectCategory("Sales Operations Analyst"), "sales-ops");
eq("MOps", detectCategory("Marketing Operations Manager"), "marketing-ops");
eq("GTM Eng", detectCategory("GTM Engineer"), "gtm-engineering");
eq("CSM", detectCategory("Customer Success Manager"), "customer-success");
eq("CS Ops", detectCategory("Customer Success Operations Lead"), "cs-ops");
...
eq("Deal Desk", detectCategory("Deal Desk Analyst"), "deal-desk");
eq("Enablement", detectCategory("Sales Enablement Manager"), "enablement");
eq("CRM admin", detectCategory("HubSpot Administrator"), "crm-admin");
